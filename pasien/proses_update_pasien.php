<?php  
	...
	$query ="UPDATE tbl_pasien SET nama_pasien='$nama_pasien', jk_pasien='$jk_pasien', alamat_pasien='$alamat_pasien', no_hp_pasien='$no_hp_pasien' WHERE id_pasien='$id_pasien'";
