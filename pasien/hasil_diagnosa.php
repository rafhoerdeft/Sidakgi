            ...
            <div class="row page-titles">
                ...
                <div class="col-md-6 align-self-center">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item"><a href="index.php?x=diagnosa&&nav=diagnosa" class="text-danger">Diagnosa Pasien</a></li>
            ...
            <div class="container-fluid">
                ...
                <!-- <div class="card"> -->
                    <!-- <div class="card-body p-b-20"> -->
                        ...
                        <?php  
                            $sql = "SELECT *, (SELECT gigi.jenis_gigi FROM tbl_jenis_gigi gigi WHERE gigi.id_jenis_gigi = rm.id_jenis_gigi) jenis_gigi FROM tbl_pasien ps, tbl_rekam_medik rm WHERE ps.id_pasien = rm.id_pasien ORDER BY rm.id_rm DESC limit 1"; 
                            $result = $db->query($sql);
                        ...
                        ?>         
                                <div class="row">
                                    ...
                                    <div class="col-md-4 m-b-10">
                                        <a class="btn btn-block btn-primary" href="laporan/lap_hasil_diagnosa.php?z=<?= $row['id_rm'] ?>"><i class="fa  fa-file-pdf-o"></i> Export PDF</a>
                                    </div>
                                </div>
                                ...
                                <div class="ribbon-wrapper card">
                                    <div class="ribbon ribbon-danger">Gigi :</div>
                                    <table class="ribbon-content" border="0" cellpadding="10">
                                        <tr>
                                            <td width="150">
                                                Jenis Gigi
                                            ...
                                            <td width="10"> : </td>
                                            <td>
                                                <span style="font-weight: bold;"><?= $row['jenis_gigi'] ?></span>
                                            </td>
                                        </tr>
                                    </table>
                                </div>
