                                ...
                                <tbody>
                                    ...
                                    ?>
                                            <tr>
                                                ...
                                                <td><?= $row['username'] ?></td>
                                                <td>
                                                    <button type="button" data-id="<?= $row['id_pasien'] ?>" data-nama="<?= $row['nama_pasien'] ?>" data-almt="<?= $row['alamat_pasien'] ?>" data-jk="<?= $row['jk_pasien'] ?>" data-hp="<?= $row['no_hp_pasien'] ?>" data-user="<?= $row['username'] ?>" onclick="showModalEdit(this)" class="btn btn-sm waves-effect waves-light btn-info" style="width: 40px; margin-bottom: 5px" title="Edit Data"><i class="fa fa-pencil-square-o"></i></button>
                        ...
                        <form id="tambahDataPasien" method="POST" action="proses_tambah_pasien.php">
                            <div class="modal-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="controls">
                                        <input required type="text" class="form-control" name="username" id="username" placeholder="Isi nama pasien">
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="controls">
                                        <input type="text" class="form-control" name="password" id="password" placeholder="Isi password pasien jika ingin diganti">
                                    </div>
                                </div>
        ...
        <script type="text/javascript">
            ...
            function showModalEdit(data) {
                ...
                // var password = $(data).attr('data-pass');
                ...
                //     var dt = JSON.parse(result);
                    ...
                    // if (dt.response) {
                        ...
                        $('#modal-edit #updateDataPasien #username').val(username);
                        // $('#modal-edit #updateDataPasien #password').val(password);
