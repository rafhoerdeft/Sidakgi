            ...
            <div class="container-fluid">
                ...
                <div class="card-group">
                    ...
                    <!-- <div class="card card-inverse card-info m-1">
                        <a href="index.php?x=data_user&&nav=user">
                            <div class="card-body">
                                <div class="d-flex" style="margin-top: -10px; margin-bottom: -20px">
                                    ...
                                    <div style="margin-top: 14px">
                                        <h3 class="card-title">
                                            <?php  
                                                $query ="SELECT id_user FROM tbl_user";
                                                $result = $db->query($query);
                                                $jmlUser = $db->num_rows($result);

                                                echo $jmlUser;
                                            ?>
                                        </h3>
                                        <h5 class="card-subtitle text-white">Jumlah User</h5></div>
                                </div>
                            </div>
                        </a>
                    </div> -->
                    ...
                    <div class="card card-inverse card-warning m-1">
                        <a href="index.php?x=data_kasus&&nav=kasus">
                            <div class="card-body">
                                <div class="d-flex" style="margin-top: -10px; margin-bottom: -20px">
                                    <div class="m-r-20 align-self-center">
                                    ...
                                    <div style="margin-top: 14px">
                                        ...
                                        <h5 class="card-subtitle text-white">Data Kasus</h5></div>
                                </div>
                            </div>
                        </a>
                    </div>
                            ...
                            <div class="card-body">
                                <div class="d-flex" style="margin-top: -10px; margin-bottom: -20px">
                                    ...
                                    <div style="margin-top: 14px">
                                        ...
                                        <h5 class="card-subtitle text-white">Pasien Terdaftar</h5></div>
                                </div>
                            </div>
                        </a>
                    </div>

                    <div class="card card-inverse card-primary m-1">
                            ...
                            <div class="card-body">
                                <div class="d-flex" style="margin-top: -10px; margin-bottom: -20px">
                                    ...
                                    <div style="margin-top: 14px">
                                        ...
                                        <h5 class="card-subtitle text-white">Rekam Medik Pasien</h5></div>
                                </div>
                            </div>
                        </a>
                    </div>
